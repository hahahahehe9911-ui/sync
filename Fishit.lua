...
local Chloex   = loadstring(game:HttpGet("https://raw.githubusercontent.com/hahahahehe9911-ui/sync/refs/heads/main/moduls/Library"))()
...
local BaseFolder           = "Syndicate/FishIt"
...
If:AddParagraph({
    Title = "Syndicate Official Discord!",
    Content = "Join Us!",
    Icon = "discord",
    ButtonText = "Copy Discord Link",
    ButtonCallback = function()
        local link = "https://discord.gg/getSyndicate"
...
Fish:AddToggle({
    ...
    Callback = function(state)
        if state then
            ...
            title.Text = "Syndicate FIshing Panel"
            title.TextSize = 22
                    ...
                    for _, plr in ipairs(game:GetService("Players"):GetPlayers()) do
                        if plr ~= game.Players.LocalPlayer then
                            ...
                            if StaffRoles[rank] then
                                game.Players.LocalPlayer:Kick("Syndicate Detected Staff, Automatically Kicked!")
                                return
                            end
                        end
                    end
